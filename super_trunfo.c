...
int main() {
    ...
    int pontos_turisticos1, pontos_turisticos2, num_carta = 1;
    ...
    printf("População: Carta %d venceu (%d)\n", num_carta, populacao1 > populacao2);
    printf("Área: Carta %d venceu (%d)\n", num_carta, area1 > area2);
    printf("PIB: Carta %d venceu (%d)\n", num_carta, pib1 > pib2);
    printf("Pontos Turísticos: Carta %d venceu (%d)\n", num_carta, pontos_turisticos1 > pontos_turisticos2);
    printf("Densidade Populacional: Carta %d venceu (%d)\n", num_carta, densidade_pop1 < densidade_pop2);
    printf("PIB per Capita: Carta %d venceu (%d)\n", num_carta, pib_percapita1 > pib_percapita2);
    printf("Super Poder: Carta %d venceu (%d)\n", num_carta, super_poder1 > super_poder2);
